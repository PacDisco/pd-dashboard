...
| `test/shirt-orders-auth.test.mjs` | 35 assertions on Shopify credential handling (client credentials grant, token caching/refresh) and the order guardrails. `npm run test:shirt-auth` |
