...
-- ==========================================================================
-- Flight Programs (student flight booking portal)
--   Backs the "Flight Programs" admin dashboard and the public student portal.
--   SEPARATE from the `programs` lookup above (that one is the finance/ops
--   categorization used by `payments`). Travel programs need an airport +
--   arrival/end datetimes, so they live here to avoid coupling.
-- ==========================================================================
